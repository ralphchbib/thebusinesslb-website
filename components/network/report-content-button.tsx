...
export function ReportContentButton({ targetCollection, targetId }: { targetCollection: "reviews" | "recommendations" | "messages" | "market-postings"; targetId: string | number }) {
